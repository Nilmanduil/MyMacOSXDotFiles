...
export ZSH="/Users/tgoudouneix/.oh-my-zsh"
...
# export PATH=$ANDROID_HOME/platform-tools:$ANDROID_HOME/build-tools/$ANDROID_VERSION:$ANDROID_HOME/tools:$GRADLE_HOME/bin:$PATH
